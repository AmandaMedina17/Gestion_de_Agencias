...
const iconPaths: Record<IconName, string> = {
  ...
  calendar: 'M15 4V2M15 4V6M15 4H10.5M3 10V19C3 20.1046 3.89543 21 5 21H19C20.1046 21 21 20.1046 21 19V10H3Z M3 10V6C3 4.89543 3.89543 4 5 4H7 M7 2V6 M21 10V6C21 4.89543 20.1046 4 19 4H18.5',
