...
export class ResponsableID {
    ...
    public static create(): ResponsableID {
        const newId = new ResponsableID(ResponsableID.nextId);
        ResponsableID.nextId++;
        return newId;
    }
    ...
    public equals(other: ResponsableID): boolean {
        return this.value === other.value;
    }

    public toString(): string {
        return `RESP-${this.value.toString().padStart(3, '0')}`;
    }
}
